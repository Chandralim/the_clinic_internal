<template>
  ...
  <FormsMUser :show="forms_m_user_show" :fnClose="()=>{forms_m_user_show=false}" :id="forms_m_user_id" :p_data="m_users"/> -->
...
//   {key:"user_name", label: "Username", freeze: 0, filter_on: 1, type: 'string', sort: { priority: 2, type: "asc" } },
...
//     display({ show: true, status: "Failed", message: "Silahkan Pilih Data Terlebih Dahulu" });
//   } else {
//     router.push({ name: 'm_user-permission', query: { id: m_users.value[selected.value].id } });
//   }
// };
//     // form_inject(){
//     //   if (selected==-1) {
...
//     //     });
//     //   }else {
//     //     this.$router.push({name:'product-material_controls',query:{product_id:m_users[selected].id,status:"Inject"}})
//     //   }
//     // },
//     // form_rest(){
//     //   if (selected==-1) {
...
//     //     });
//     //   }else {
//     //     this.$router.push({name:'product-material_controls',query:{product_id:m_users[selected].id,status:"Rest"}})
//     //   }
//     // },
