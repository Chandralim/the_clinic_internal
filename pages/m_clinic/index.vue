<template>
  <div class="w-full h-full flex flex-col">
    ...
    <!-- <div class="w-full flex grow flex-col overflow-auto h-0">
      ...
      <TableView :thead="fields_thead" :selected="selected" @setSelected="selected = $event" :tbody="m_clinics" :fnCallData="callData" :scrolling="scrolling" @setScrollingPage="scrolling.page=$event"  @doFilter="searching()" :rowBgColor="rowBgColor">
...
//   {key:"code",label:"Code",freeze:0, filter_on:1,type:'string',sort:{priority:1,type:"asc"}},
