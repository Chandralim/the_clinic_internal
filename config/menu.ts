export const menuList = [
  ...
  },
  {
    ...
    permission: 'trp_trx.ticket.views',
    title: "Ticket Logistik",
    icon: 'IconsProduct'
  },
  {
    activeMenu: "/data_trx_trp/ritase",
    permission: 'trp_trx.ritase.views',
    title: "Trx Ritase",
    icon: 'IconsProduct'
  },
  {
    activeMenu: "/clinic",
    permission: 'platform*clinic.views',
    title: "Clinic",
    icon: 'IconsProduct'
  },
  {
  ...
  },
  {
    ...
    permission: 'standby_trx.views',
    title: "StandBy Trx",
    icon: 'IconsMoney'
  },
  {
    activeMenu: "/vehicle",
    permission: 'vehicle.views',
    title: "Vehicle",
    icon: 'IconsTruck'
  },
  {
...

  {
    ...
    permission: 'salary_paid.views',
    title: "Salary Paid",
    icon: 'IconsMoneyBag'
  },
  {
    activeMenu: "/salary_paid/rpt",
    permission: 'rpt_salary.views',
    title: "Salary Report",
    icon: 'IconsFileCopy'
  },
  {
    activeMenu: "/salary_bonus",
    permission: 'salary_bonus.views',
    title: "Salary Additional",
    icon: 'IconsMoneyBag'
  },
  {
    activeMenu: "/user",
    permission: 'platform*user.views',
    title: "User",
    icon: 'IconsPerson'
  },
  {
    activeMenu: "/role",
    permission: 'platform*role.views',
    title: "Role",
    icon: 'IconsPeople'
  },
  // {
  //   activeMenu:"/report_trx_trp",
  //   permission:'trp_trx.report.views',
  //   title:"Report Susut",
  //   icon:'IconsFileCopy'
  // },
  // {
  ...
  //   permission:'report.ramp.views',
  //   title:"Rpt Hsl Trip",
  //   icon:'IconsFileCopy'
  // },
  // {
  //   activeMenu:"/report/ast_n_driver",
  //   permission:'report.ast_n_driver.views',
  //   title:"Rpt Gaji Supir & Kernet",
  //   icon:'IconsFileCopy'
  // },
  // {
  //   activeMenu:"/report/distance",
  //   permission:'report.distance.views',
  //   title:"Rpt Jarak",
  //   icon:'IconsFileCopy'
  // },
]