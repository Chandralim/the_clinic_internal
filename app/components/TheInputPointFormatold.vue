...
const clearNumber = (val: string | number)=>{
...
const humanNumber=(val: string | number)=>{
...
const fromDBToHuman=(val: string | number)=>{
...
const change=(val: string | number,outsider=false)=>{
  // if(val=="-") {
  //   inputVal.value = "-";
  //   return;
  // }
